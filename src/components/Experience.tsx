  ...
  const experiences: ExperienceItem[] = [
    ...
    },
    {
      ...
      highlights: [
        ...
        'Created comprehensive reports using Power BI and SQL',
        'Presented findings to C-level executives and stakeholders',
      ],
      logoSrc: '/logos/analytics-plus.svg',
      logoAlt: 'Analytics Plus',
    },
    {
      ...
      highlights: [
        'Researched optimization algorithms for supply chain networks',
        'Implemented Python simulations improving efficiency by 12%',
        'Published findings in a peer-reviewed academic conference',
      ],
      logoSrc: '/logos/nextgen-systems.svg',
      logoAlt: 'NextGen Systems',
    },
  ];
