  ...
  const socialLinks = [
    {
      ...
      label: 'LinkedIn',
      color: 'hover:text-blue-600 dark:hover:text-blue-400 hover:scale-110 transition-transform'
    },
    {
      icon: Github,
      href: 'https://github.com/vatsakala',
      label: 'GitHub',
      color: 'hover:text-black dark:hover:text-white hover:scale-110 transition-transform'
    },
    {
      icon: Mail,
      href: 'mailto:vatsakala.contact@gmail.com',
      label: 'Email',
      color: 'hover:text-red-600 dark:hover:text-red-400 hover:scale-110 transition-transform'
    }
  ];
